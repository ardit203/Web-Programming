package mk.ukim.finki.wp.lab1_a.web.servlet;
...
import mk.ukim.finki.wp.lab1_a.service.BookReservationService;
...
/// /////////////////////////////////////////////////////////////////////////////
        ...
        List<String> lastBooks = (List<String>) req.getSession().getAttribute("lastBooks");
        if(lastBooks == null){
            lastBooks = new ArrayList<String>();
        }

        if (lastBooks.size() == 3) {
            lastBooks.remove(lastBooks.size() - 1);
        }
        lastBooks.add(0, bookTitle);
        req.getSession().setAttribute("lastBooks", lastBooks);
