...
- Статична листа: `public static List<Chef> books = new ArrayList<>();` иницијализирана со **5 вредности**
- Статична листа: `public static List<Dish> reservations = new ArrayList<>();` иницијализирана со **5 вредности**
...
Креирајте класа `InMemoryDishRepository` која го имплементира `InMemoryDishRepository` интерфејсот.
